...
<table class="concordtable fullwidth">
	...
	<tr>
		<td class="concordgeneral">
			...
			<p>
				The Docker image used as backbone of this CQPweb instance has been compiled
				and is maintained by Daniel Bodky (FAU Erlangen-Nuremberg).
			</p>
			...
			<ul>
				...
				<li>
					The container techology making CQPweb and its prerequisites work out of the box is called <a target="_blank" href="https://docker.com">Docker</a>
				</li>
			</ul>			
...
* yet more work on dist / subcorpus still needed. (but possibly post-3.3
* complete dispersion integration
* get keywords working again properly (esp clouds)

That should be all - then, merge to 3.3
 -->		
 		<li>
...
function do_ui_bugs()
{
	...
	<table class="concordtable fullwidth">
		...
		<tr>
			...
			<h3>Docker problems</h3>

			<p>
				Problems regarding the configuration of this CQPweb instance from within the provided 
				Docker container should not be reported as bugs. Instead, you can contact Daniel Bodky via Email at
				<strong>'daniel.bodkyatfau.de'</strong> or file an issue at <a target="_blank" href="https://github.com/mocdaniel/docker-cqpweb">his GitHub page</a>
			</p>		
